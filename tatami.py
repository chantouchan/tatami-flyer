...
st.set_page_config(page_title="畳販促支援プラットフォーム", layout="wide")

st.title("🏠 畳販促支援プラットフォーム")
st.subheader("チラシを選んで、印刷するだけ。")
...
st.markdown(
    ...
    <div style="
        ...
        border-radius: 4px;
    ">
        <div style="font-size: 12px; color: #888;">2026年4月24日</div>
        <div style="font-size: 16px; font-weight: bold; color: #333;">🆕 新商品「ペット向け畳 プレミアム」販売開始</div>
        <div style="font-size: 14px; color: #555; margin-top: 4px;">従来品より耐久性が30%向上。消臭機能もさらにパワーアップしました。</div>
    </div>
    <div style="
        background: #E3F2FD;
        ...
        border-radius: 4px;
    ">
        <div style="font-size: 12px; color: #888;">2026年4月15日</div>
        <div style="font-size: 16px; font-weight: bold; color: #333;">📣 夏のキャンペーンチラシを追加しました</div>
        <div style="font-size: 14px; color: #555; margin-top: 4px;">張替えキャンペーン用の新デザインが選べるようになりました。</div>
    </div>
    <div style="
        background: #F3E5F5;
        ...
        border-radius: 4px;
    ">
        <div style="font-size: 12px; color: #888;">2026年4月1日</div>
        <div style="font-size: 16px; font-weight: bold; color: #333;">🎉 畳販促支援プラットフォームがオープンしました</div>
        <div style="font-size: 14px; color: #555; margin-top: 4px;">チラシ作成・配布がこのプラットフォームから簡単に行えます。</div>
    </div>
    """,
...
st.markdown(
    ...
    ">
        ...
        <div style="
            ...
            margin-top: 8px;
        ">
            <div style="font-size: 14px; color: #888;">お問い合わせ・ご相談はこちら</div>
            <div style="font-size: 20px; font-weight: bold; color: #333; margin-top: 8px;">
                🏠 あなたの店舗名がここに入ります
            </div>
